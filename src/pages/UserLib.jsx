    ...
    useEffect(() => {
        const fetchRecommendations = async () => {
            ...
            try {
                ...
                const animeIds = result.data.animeRecommendations; // Array of anime IDs
                console.log(animeIds);
                const animeDetails = await fetchAnimeDetails(animeIds);
        ...
        {animeRecommendations.map((anime) => (
            ...
            >
                ...
                <p className="text-sm text-gray-400 mt-2">
                    {anime.genres?.map((genre) => genre.name).join(", ") || "Unknown Genre"}
                </p>
        ...
        {userRecommendations.map((user, index) => (
            ...
            >
                <div className="flex items-center space-x-4">
                    {/* <div className="w-16 h-16 bg-gray-700 rounded-full flex items-center justify-center text-lg font-bold text-blue-400">
                    ...
                    <div>
                        ...
                        {/* <p className="text-sm text-gray-400 mt-1">
                            Similar Taste Score: {user.similarityScore || "N/A"}
                        </p> */}
                    </div>
                </div>
                <div className="mt-4">
